...
public class Elevator implements ElevatorInterface {
  ...
  public void step() {
    ...
    if (this.outOfService) {
      this.stepOutOfService(); //this will only move the elevator for one step!
      return;
    }
  ...
  private void stepOutOfService() {
    ...
    //if the elevator is on the ground floor and the door is closed
    //then open the door and empty the floor requests, and set the direction to stopped.
